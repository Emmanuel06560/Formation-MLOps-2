...
def predict_endpoint():
    ...
    d = {"Wind_turbine_name": "R80721", "Date_time": "2017-02-08T08:00:00+01:00", "Ba_avg": 44.99, "Ba_min": 44.99,
    ...
    d['Ws1_avg'] = received_wind_speed_avg
    received_data_df = pd.DataFrame(d, index=[0])
    f = prepare_features(received_data_df, training_mode=False)
    predictions = predict(f, MODEL_PATH)
    return predictions["predictions"].to_json()
